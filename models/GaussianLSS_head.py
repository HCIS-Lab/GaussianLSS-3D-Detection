# Modified from original work: https://github.com/MCG-NJU/SparseBEV
...
class GaussianLSSHead(DETRHead):
    def __init__(self,
                 *args,
                 num_classes,
                 in_channels,
        ...
        super(GaussianLSSHead, self).__init__(num_classes, in_channels, train_cfg=train_cfg, test_cfg=test_cfg, **kwargs)
